...
func TestImplementations(t *testing.T) {
	testCases := map[string]struct {
		...
		"popcount.PopCountLoop": {
			impl: popcount.PopCountLoop,
		},
		"popcount.PopCountShift": {
			impl: popcount.PopCountShift,
		},
		"popcount.PopCountClearRightmost": {
			impl: popcount.PopCountClearRightmost,
		},
		"bits.OnesCount64": {
...
func BenchmarkPopCountClearRightmost(b *testing.B) {
	for i := 0; i < b.N; i++ {
		popcount.PopCountClearRightmost(0x1234567890ABCDEF)
	}
}
